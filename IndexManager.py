...
from RecordManager import RecordManager, RecOff, select
...
class IndexManager(RecordManager):
    ...
    def select_index(self,table_name,condition=None):
        '''
        通过索引进行查询
        '''
    def delete_index(self,table_name,condition=None):
        '''
        删除所对应的索引
        '''
def maintain_B_plus_tree_after_delete(table,__node):#删除B+树节点
    global N
